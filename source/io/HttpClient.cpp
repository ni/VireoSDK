...
DEFINE_VIREO_BEGIN(HttpClient)
    ...
    DEFINE_VIREO_FUNCTION(HttpClientClose, "p(i(.UInt32) io(ErrorClust))")
    DEFINE_VIREO_FUNCTION(HttpClientAddHeader, "p(io(.UInt32) i(.String) i(.String) io(ErrorClust))")
    DEFINE_VIREO_FUNCTION(HttpClientRemoveHeader, "p(io(.UInt32) i(.String) io(ErrorClust))")
    DEFINE_VIREO_FUNCTION(HttpClientGetHeader, "p(io(.UInt32) i(.String) o(.String) io(ErrorClust))")
    DEFINE_VIREO_FUNCTION(HttpClientHeaderExists, "p(io(.UInt32) i(.String) o(.UInt32) o(.String) io(" ERROR_CLUST_TYPE_STRING "))")
    DEFINE_VIREO_FUNCTION(HttpClientListHeaders, "p(io(.UInt32) o(.String) io(ErrorClust))")
    ...
    DEFINE_VIREO_FUNCTION(HttpClientConfigCORS, "p(io(.UInt32) i(.UInt32) io(ErrorClust))")
DEFINE_VIREO_END()
#endif
