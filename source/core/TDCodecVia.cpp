...
DEFINE_VIREO_BEGIN(DataAndTypeCodecUtf8)
    ...
    DEFINE_VIREO_FUNCTION(FlattenToJSON, "p(i(VarArgCount) i(StaticTypeAndData) i(Boolean) o(String) io(" ERROR_CLUST_TYPE_STRING "))")
    DEFINE_VIREO_FUNCTION(UnflattenFromJSON, "p(i(VarArgCount) i(String) o(StaticTypeAndData) i(a(String *)) i(Boolean) i(Boolean) i(Boolean) io(" ERROR_CLUST_TYPE_STRING "))")
