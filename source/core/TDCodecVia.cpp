...
DEFINE_VIREO_BEGIN(DataAndTypeCodecUtf8)
    ...
    DEFINE_VIREO_FUNCTION(FlattenToJSON, "p(i(VarArgCount) i(StaticTypeAndData) i(Boolean) o(String) io(ErrorClust))")
    DEFINE_VIREO_FUNCTION(UnflattenFromJSON, "p(i(VarArgCount) i(String) o(StaticTypeAndData) i(a(String *)) i(Boolean) i(Boolean) i(Boolean) io(ErrorClust))")
