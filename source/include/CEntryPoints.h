...
VIREO_EXPORT Boolean EggShell_TestNeedsUpdateAndReset(const TypeRef typeRef);
VIREO_EXPORT Boolean EggShell_TestNeedsUpdateWithoutReset(const TypeRef typeRef);
//------------------------------------------------------------
