describe('An Intensity Graph has a defined CSS API', function () {
    'use strict';

    var $ = NationalInstruments.Globals.jQuery;
    var element, controlId = 'IntensityGraphId123123', viModel;
    var elementName = 'ni-intensity-graph';
    var cssSheetId = 'niIntensityGraphCSSId';
    ...
    it('updates "ni-cartesian-graph" background-color', function () {
        ...
        expect(targetStyle.borderRadius).toEqual('25px');
    });
});
