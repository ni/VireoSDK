describe('A Cartesian Graph has a defined CSS API', function () {
    'use strict';

    var $ = NationalInstruments.Globals.jQuery;
    var element, controlId = 'CartesianGraphId123123', viModel;
    var elementName = 'ni-cartesian-graph';
    var cssSheetId = 'niCartesianGraphCSSId';
