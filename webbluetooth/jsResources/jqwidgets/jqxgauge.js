    ...
    var radialGauge = {
        ...
        createInstance: function (args)
        {
            ...
            if (self.int64 === 's')
            {
                if (!$.jqx.longInt)
                {
                    throw new Error('jqxGauge: Missing reference to jqxdata.js');
                }
            ...
            } else if (self.int64 === 'u')
            {
                ...
                {
                    throw new Error('jqxGauge: Missing reference to bignumber.js');
                }
    ...
    linearGauge = {
        ...
        createInstance: function ()
        {
            ...
            if (self.int64 === 's')
            {
                if (!$.jqx.longInt)
                {
                    throw new Error('jqxLinearGauge: Missing reference to jqxdata.js');
                }
            ...
            } else if (self.int64 === 'u')
            {
                ...
                {
                    throw new Error('jqxLinearGauge: Missing reference to bignumber.js');
                }
