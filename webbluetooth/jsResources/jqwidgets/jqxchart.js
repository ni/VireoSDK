...
(function ($) {
    ...
    $.jqx.svgRenderer.prototype = {
        ...
        init: function (host) {
            var s = "<table id=tblChart cellspacing='0' cellpadding='0' border='0' align='left' valign='top'><tr><td colspan=2 id=tdTop></td></tr><tr><td id=tdLeft></td><td><div class='chartContainer' style='position:relative' onselectstart='return false;'></div></td></tr></table>";
            host.append(s);
            this.host = host;
            ...
            for (var sidx = group.series.length - 1; sidx >= 0; sidx--) {
                ...
                do {
                    ...
                    for (var i = curr; i <= renderData.xoffsets.last; i++) {
                        ...
                        if (ptSave && this.enableSampling && $.jqx._ptdist(ptSave.x, ptSave.y, px, py) < 1)
                            continue;
