    ...
    proto.peek = function (viName, path, type) {
        ...
        switch (type) {
            ...
            case 'Number':
                ...
                break;
            case 'Complex':
                var complex = JSON.parse(this._vireo.readJSON(viName, path));
                var niComplex = new NationalInstruments.HtmlVI.NIComplex(complex.real, complex.imaginary);
                value = niComplex.toString();
                break;
            case 'Boolean':
            ...
            case 'Timestamp':
                ...
                value = this._vireo.readDouble(viName, path);
                value = new NationalInstruments.HtmlVI.NITimestamp(value).toString();
                break;
            case 'Object':
                value = JSON.parse(this._vireo.readJSON(viName, path));
                break;
    ...
    proto.poke = function (viName, path, type, data) {
        switch (type) {
            ...
            case 'Number':
                ...
                break;
            case 'Complex':
                var niComplex = new NationalInstruments.HtmlVI.NIComplex(data);
                var vireoComplex = {real: niComplex.realPart, imaginary: niComplex.imaginaryPart};
                this._vireo.writeJSON(viName, path, JSON.stringify(vireoComplex));
                break;
            case 'Boolean':
                this._vireo.writeJSON(viName, path, JSON.stringify(data));
                break;
            ...
            case 'Timestamp':
                ...
                this._vireo.writeDouble(viName, path, new NationalInstruments.HtmlVI.NITimestamp(data).valueOf());
                break;
            case 'Object':
                this._vireo.writeJSON(viName, path, JSON.stringify(data));
                break;
